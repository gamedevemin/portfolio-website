                ...
                <div className="flex items-start justify-between">
                  ...
                  {!unlockedSkills.has(category) && (
                    <div className="relative flex items-center justify-center w-6 h-6">
                      <motion.div 
                        className="text-[10px] font-semibold text-[#4efaa7]"
                        animate={{
                      ...
                      {skills.map((skill) => (
                        <div key={skill.name} className="space-y-1.5 sm:space-y-2">
                          ...
                          <div className="h-1.5 sm:h-2 bg-gray-800 rounded-full overflow-hidden">
                            <motion.div 
                              className="h-full bg-gradient-to-r from-[#4efaa7] to-[#7ffbc4] rounded-full"
                              initial={{ width: 0 }}
                              animate={{ 
        ...
        <AnimatePresence>
          {notifications.map((notification) => (
            <motion.div
              ...
              animate="animate"
              exit="exit"
              className="fixed bottom-8 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-[#4efaa7] to-[#3ef596] text-white px-6 py-3 rounded-full shadow-lg z-50 backdrop-blur-sm"
            >
