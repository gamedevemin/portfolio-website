      ...
      {isLoading ? (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-sm z-50 flex flex-col items-center justify-center">
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-amber-500 to-amber-300 opacity-20 blur-xl animate-pulse" />
          </div>
          <p className="mt-8 text-lg font-medium text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-amber-300">
